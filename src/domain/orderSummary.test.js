...
import { orderBusinessDate, orderGroupKey, summarizeOrders } from './orderSummary'
...
describe('orderSummary', () => {
  ...
  it('summarizes the full eligible scoped period by payment method and group', () => {
    ...
    expect(result.totals).toEqual({ orders: 3, cash: 100_000, transfer: 250_000, revenue: 400_000 })
  ...
  it('preserves valid legacy numeric-string VND amounts', () => {
    expect(summarizeOrders([
      ...
      orders: 1, cash: 125_000, transfer: 0, revenue: 125_000,
    })
  })
