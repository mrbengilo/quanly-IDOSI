...
export const STORE_VIOLATIONS = deepFreeze([
  { code: 'store.violation.late', label: 'Đi trễ', amountVnd: 2_000, violationPoints: 0.5 },
  { code: 'store.violation.forgot_attendance', label: 'Quên chấm công', amountVnd: 2_000, violationPoints: 0.5 },
  { code: 'store.violation.ignore_customer', label: 'Không quan tâm khách hàng', amountVnd: 2_000, violationPoints: 2 },
  { code: 'store.violation.dark_hot_no_music', label: 'Cửa hàng tối, nóng hoặc không có nhạc', amountVnd: 2_000, violationPoints: 0.5 },
  { code: 'store.violation.dirty_restroom', label: 'Toilet không sạch', amountVnd: 5_000, violationPoints: 1 },
  { code: 'store.violation.dirty_altar_table', label: 'Bàn thờ không sạch', amountVnd: 2_000, violationPoints: 1 },
  { code: 'store.violation.dirty_floor', label: 'Sàn không sạch', amountVnd: 8_000, violationPoints: 1 },
  { code: 'store.violation.clothes_or_hangers_on_floor', label: 'Quần áo hoặc móc treo nằm trên sàn', amountVnd: 2_000, violationPoints: 0.5 },
  { code: 'store.violation.empty_hangers', label: 'Còn móc trống', amountVnd: 2_000, violationPoints: 0.5 },
  { code: 'store.violation.empty_rack_not_filled', label: 'Sào trống chưa được bổ sung quần áo', amountVnd: 2_000, violationPoints: 0.5 },
  { code: 'store.violation.no_sorting', label: 'Không phân loại hàng', amountVnd: 8_000, violationPoints: 0.5 },
  { code: 'store.violation.wrong_payment_location', label: 'Đặt sai vị trí hình thức thanh toán', amountVnd: 5_000, violationPoints: 0.5 },
  { code: 'store.violation.wrong_app_info_requires_manager', label: 'Sai thông tin trên ứng dụng cần quản lý xử lý', amountVnd: 2_000, violationPoints: 0.5 },
  { code: 'store.violation.merged_or_wrong_time_order', label: 'Gộp đơn hoặc sai thời gian đơn hàng', amountVnd: 5_000, violationPoints: 0.5 },
  { code: 'store.violation.phone_over_30_minutes', label: 'Sử dụng điện thoại quá 30 phút', amountVnd: 5_000, violationPoints: 1 },
])
...
const staffCatalogItems = (targetGroup, kind, records) => records.map((record, index) => ({
  ...
  name: record.label,
  amountVnd: record.violationPoints != null ? 0 : record.amountVnd || 0,
  ...(record.violationPoints != null ? { violationPoints: record.violationPoints } : {}),
