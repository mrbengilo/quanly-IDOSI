...
describe('customerSurveySummary', () => {
  it('filters by store/month and produces stable customer insights', () => {
    const result = customerSurveySummary([
      ...
      { id: '2', storeId: 'S01', createdAt: '2026-08-02T08:00:00+07:00', gender: 'Nữ', customerAge: 28, acquisitionChannel: 'Facebook', occupation: 'Nhân viên' },
      { id: '3', storeId: 'S01', createdAt: '2026-08-03T08:00:00+07:00', gender: 'Nam', customerAge: 23, acquisitionChannel: 'TikTok', occupation: 'Sinh viên' },
    ...
    expect(result.insights).toMatchObject({ topGender: 'Nữ', topChannel: 'TikTok', topAge: '18–24', topOccupation: 'Sinh viên' })
  })
})
