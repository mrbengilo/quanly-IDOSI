...
const storeOperations = [
  ...
  { label: 'Vi phạm nhân viên', path: '/store/violations', icon: ShieldAlert, roles: ['store_manager'] },
...
const officeEmployeeMenu = [
  ...
  { label: 'Công việc cố định', path: '/employee/tasks', icon: ClipboardCheck },
  ...
  { label: 'Lương của tôi', path: '/employee/payroll', icon: WalletCards },
  { label: 'Thưởng của tôi', path: '/employee/compensation', icon: Award },
...
const systemMenus = {
  ...
  employee: [
    ...
    { label: 'Lương của tôi', path: '/employee/payroll', icon: WalletCards },
    { label: 'Công việc tính thưởng', path: '/employee/compensation', icon: Award },
    { label: 'Vi phạm của tôi', path: '/employee/violations', icon: ShieldAlert },
