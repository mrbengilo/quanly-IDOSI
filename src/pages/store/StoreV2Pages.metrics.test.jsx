...
describe('store order, attendance, and payroll summaries', () => {
  ...
  it('keeps the full monthly store totals when filtering the displayed orders', () => {
    ...
    expect(within(screen.getByLabelText('Doanh thu tháng của cửa hàng')).getAllByText('400,000 đ')).toHaveLength(2)
  ...
  it('attributes a support work reward to the destination payroll without leaking it to the home store', () => {
    ...
    const supportTag = within(row).getByText('Nhân viên hỗ trợ • Từ Dosii TNV')
  ...
  it('preserves employeeCode aliases and inbound support employees from an immutable payroll snapshot', () => {
    ...
    const snapshotSupportTag = within(supportRow).getByText('Nhân viên hỗ trợ • Từ Dosii TNV')
