...
export function StoreSettings() {
  ...
  return (
    <div className="page settings-page">
      ...
      {!canManageStore && <InfoNote>Chế độ chỉ xem. Tài khoản hiện tại không thể thay đổi cài đặt cửa hàng.</InfoNote>}
