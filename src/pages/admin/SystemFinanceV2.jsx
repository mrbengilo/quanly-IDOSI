...
export function AdminCashflowV2() {
  ...
  const displayedSourceDatePage = Math.min(sourceDatePage, sourceDates.length - 1)
  const sourceDate = sourceDates[displayedSourceDatePage] || currentDate
      ...
      <Card
        ...
        action={<div className="toolbar-wrap cashflow-source-toolbar">
          ...
          <Button
            ...
            disabled={displayedSourceDatePage === 0}
          ...
          <Button
            ...
            disabled={displayedSourceDatePage >= sourceDates.length - 1}
