  ...
  return (
    <div className="page">
      ...
      <div className="metrics-grid metrics-grid--4">
        <MetricCard label="TỔNG NHÂN VIÊN" value={employees.length} icon={Users} tone="blue" />
        <MetricCard label="ĐANG LÀM VIỆC" value={employees.filter((item) => item.status === 'Đang làm việc').length} icon={ShieldCheck} tone="green" />
