...
describe('Admin work registration schedule', () => {
  ...
  it('renders two isolated read-only groups for the selected week', () => {
    ...
    expect(document.querySelector('.work-registration-page')).toBeTruthy()
    expect(support.classList.contains('work-registration-scroll')).toBe(true)
    expect(support.querySelector('.work-registration-grid')).toBeTruthy()
    expect(support.closest('.work-registration-group')).toBeTruthy()
