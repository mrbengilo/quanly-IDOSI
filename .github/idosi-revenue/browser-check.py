...
with sync_playwright() as p:
 ...
 try:
  ...
  quantity=dialog.get_by_label('Số lượng Đồ nam',exact=True)
  increase=dialog.get_by_role('button',name='Tăng số lượng Đồ nam',exact=True)
  decrease=dialog.get_by_role('button',name='Giảm số lượng Đồ nam',exact=True)
  choice=dialog.get_by_role('checkbox',name=re.compile('Đồ nam'))
  for width in [320,360,390,430,1440]:
   ...
   row=dialog.locator('.order-item-selector__row').filter(has=page.get_by_label('Số lượng Đồ nam',exact=True))
  ...
  weight=dialog.get_by_label('Khối lượng Đồ nam',exact=True)
  kg_increase=dialog.get_by_role('button',name='Tăng khối lượng Đồ nam',exact=True)
  kg_decrease=dialog.get_by_role('button',name='Giảm khối lượng Đồ nam',exact=True)
  ...
  weight.fill('0.5')
  weight.press('Tab')
  expect(dialog.get_by_label('Đơn giá Đồ nam',exact=True)).to_have_value('20,000')
  weight.fill('2')
  kg_increase.click()
  expect(weight).to_have_value('2.5')
  ...
  for _ in range(3): dialog.get_by_role('button',name='Tăng số lượng Đồ nam',exact=True).click()
  expect(dialog.get_by_label('Số lượng Đồ nam',exact=True)).to_have_value('3')
