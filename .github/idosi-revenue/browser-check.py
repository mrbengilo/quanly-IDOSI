...
with sync_playwright() as p:
 ...
 try:
  ...
  for width in [320,360,390,430,1440]:
   ...
   row=dialog.locator('.order-item-selector__row').filter(has=quantity)
  ...
  dialog.get_by_role('button',name='Tăng khối lượng Đồ nam',exact=True).click()
  dialog.get_by_label('Khối lượng Đồ nam',exact=True).fill('2.499')
  dialog.get_by_role('button',name='Tăng khối lượng Đồ nam',exact=True).click()
  expect(dialog.get_by_label('Khối lượng Đồ nam',exact=True)).to_have_value('2.5')
  dialog.get_by_label('Đơn giá Đồ nam',exact=True).fill('20000')
  dialog.get_by_label('Khối lượng Đồ nam',exact=True).fill('0')
  dialog.get_by_label('Khối lượng Đồ nam',exact=True).fill('0.5')
  dialog.get_by_label('Khối lượng Đồ nam',exact=True).press('Tab')
